...
//   };
//
//   const updateTaskStatus = async (taskId: string, newStatus: string, customStartDate?: string) => {
//     try {
...
//   };
//
//   const handleBulkStartTasks = (customStartDate?: string) => {
//     selectedTasks.forEach(taskId => updateTaskStatus(taskId, 'in_progress', customStartDate));
//     setSelectedTasks([]);
...
//                             {task.status === 'pending' ? 'Start' : 'Restart'}
//                           </Button>
//                         )}
//
...
//                               {task.status === 'pending' ? 'Set to In Progress' : 'Restart Task'}
//                             </DropdownMenuItem>
//                             <DropdownMenuItem
//                               onClick={() => updateTaskStatus(task.id, 'completed')}
//                               disabled={task.status === 'completed'}
...
//       )}
//
//       {/* Bulk Start Tasks Dialog */}
//       {bulkStarting && (
//         <StartTaskDialog
//           open={bulkStarting}
//           onOpenChange={(open) => !open && setBulkStarting(false)}
//           taskTitle={`${selectedTasks.length} selected task${selectedTasks.length > 1 ? 's' : ''}`}
//           onStartTask={handleBulkStartTasks}
//         />
//       )}
//     </div>
//   );
